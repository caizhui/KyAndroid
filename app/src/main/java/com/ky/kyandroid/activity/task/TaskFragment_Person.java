...
public class TaskFragment_Person extends Fragment {
    ...
    public void addPersonInfo() {
        View view = LayoutInflater.from(TaskFragment_Person.this.getActivity()).inflate(R.layout.dialog_person_add, null);
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(TaskFragment_Person.this.getActivity());
        ...
        builder.setPositiveButton("确定", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                if (tFtSjRyEntityList != null && tFtSjRyEntityList.size() > 0) {
                    adapter = new EventPersonListAdapter(tFtSjRyEntityList, TaskFragment_Person.this.getActivity());
                    personList.setAdapter(adapter);
                }
            }
        });
