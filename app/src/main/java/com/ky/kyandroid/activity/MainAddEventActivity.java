...
public class MainAddEventActivity extends AppCompatActivity {

    private static final String TAG = "MainAddEventActivity";
    /**
     * 导航栏左右按钮
     */
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_addevent);
    ...
    @OnClick({R.id.left_btn, R.id.event_img, R.id.cgx_img, R.id.message_img,R.id.jdpj_img,R.id.gzjb_img})
    public void onClick(View v) {
