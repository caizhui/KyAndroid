...
public class MainHandleEventActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_eventhandle);
    ...
    @OnClick({R.id.left_btn, R.id.task_img, R.id.supervision_img,R.id.message_img,R.id.jdpj_img,R.id.gzjb_img})
    public void onClick(View v) {
